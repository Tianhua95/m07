...
<head>
	<meta charset="UTF-8">
	<title>Cart - Blingbling & Co.</title>
			...
			<div class="cart-card">
				<div class="item-card">
					...
					<div class="cartItem flex-none">
						<a href="product_item.php?id=1" class="price" style="color: #0D0D0D; text-align: left; font-size: 2em;text-decoration: none;">Necklace</p></a>
					...
					<div class="flex-stretch"></div>
					<div class="description flex-none" id="product-price" style="color: #0D0D0D; min-height: min-content; margin-top: 0; margin-right: 4vh">$40
					</div>
				</div>
